...
public class TestWalkingChar extends SimpleApplication implements ActionListener, PhysicsCollisionListener, AnimEventListener {
    ...
    private void setupKeys() {
        ...
        inputManager.addMapping("CharSpace", new KeyTrigger(KeyInput.KEY_J));
...
//        effect.setLocalScale(100);
    ...
    public void simpleUpdate(float tpf) {
        ...
        if (left) {
            walkDirection.addLocal(new Vector3f((float)(camLeft.x+0.3), 0, camLeft.z));
        ...
        System.out.println(walkDirection.x+" "+walkDirection.y+" "+walkDirection.z);
