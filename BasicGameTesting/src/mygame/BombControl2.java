 ...
 * @author normenhansen
 */
public class BombControl2 extends RigidBodyControl implements PhysicsCollisionListener, PhysicsTickListener {
    ...
    public BombControl2(CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
    }

    public BombControl2(AssetManager manager, CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
